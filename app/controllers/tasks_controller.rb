class TasksController < ApplicationController
  ...
  def index
    ...
    format.pdf {
      ...
      send_data pdf.render, filename: "tasks.pdf",
    ...
    if params[:file].nil?
      ...
      if !params[:file].nil? && @errors.empty?
        doc.xpath("//task").each do |task|
          ...
          Task.create(:name=>task_name,:status=>status_id(task_status),:priority=>priority_task_id(task_priority),:start_at=>task_start_date,:end_at=>task_end_date,:project_id=>current_project.id)
